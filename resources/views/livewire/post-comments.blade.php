<div class="pt-10 mt-10 border-t border-gray-100 comments-box">
    ...
    @auth
        ...
        <button wire:click="postComment"
            class="items-center justify-center h-10 px-4 mt-3 border-solid text-black bg-blue-700  transition duration-200 rounded-lg focus:shadow-outline focus:outline-none">
            Post Comment
        </button>
    @else
